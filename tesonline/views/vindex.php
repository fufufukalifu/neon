                ...
                <div class="container">
                     <div class="section-header text-center">
                        <h2 class="section-title">
                            <p class="font-alt nm">Kenapa Latihan Soal di Netjoo?</p>
                        </h2>
                    </div>
                    <!-- START row -->
                    <div class="row">
          ...
          <!-- START Recent Blog Section -->
            <section class="section">
                <div class="container">
                    <div class="section-header text-center">
                        <h2 class="section-title">
                            <p class="font-alt nm">Ada Soal Apa Saja di Tes Online Netjoo?</p>
                                ...
                                <div class="col-sm-3">
                                    ...
                                    <div class="panel panel-danger">
                                        ...
                                        <div class="panel-body text-center" style="margin-top:-50px;">
                                            <img class="img-circle" src="<?=base_url('assets/image/avatar/cat1.jpg');?>" alt="" Height="75" width="75">
                        ...
                        <!--/ END Panel pricing -->
                                ...
                                <div class="col-sm-3">
                                    <div class="panel panel-primary">
                                        ...
                                        <!-- panel body -->
                                        <div class="panel-body text-center" style="margin-top:-50px;">
                                            <img class="img-circle" src="<?=base_url('assets/image/avatar/cat2.jpg');?>" alt="" Height="75" width="75">
                                            <h4 class="text-center text-primary semibold mb0">SMP</h4>
                                        </div>
                                        <!--/ panel body -->
                                        <!-- table -->
                                        <table class="table">
                                            <tbody>
                                                <tr>
                                                    <td colspan="2" align="center"><button class="btn btn-primary">Coba Test</button></td>
                                                </tr>
                                            </tbody>
                                        </table>
                                <!--/ table -->
                                ...
                                <div class="col-sm-3">
                                    <div class="panel panel-teal">
                                        ...
                                        <!-- panel body -->
                                        <div class="panel-body text-center" style="margin-top:-50px;">
                                            <img class="img-circle" src="<?=base_url('assets/image/avatar/cat3.jpg');?>" alt="" Height="75" width="75">
                                        ...
                                        <table class="table">
                                            <tbody>
                                                <tr>
                                                    <td colspan="2" align="center"><button class="btn btn-teal">Coba Test</button></td>
                                                </tr>
                                            </tbody>
                                        </table>
                                <!--/ table -->
                                ...
                                <div class="col-sm-3">
                                    <div class="panel panel-teal">
                                        ...
                                        <!-- panel body -->
                                        <div class="panel-body text-center" style="margin-top:-50px;">
                                            <img class="img-circle" src="<?=base_url('assets/image/avatar/cat4.jpg');?>" alt="" Height="75" width="75">
                                            <h4 class="text-center text-primary semibold mb0">SMK</h4>
                                        </div>
                                        <!--/ panel body -->
                                        <!-- table -->
                                        <table class="table">
                    ...
                    <div class="container">
                        ...
                        <div class="section-header text-center">
                            <h2 class="section-title">
                                ...
                                <small>Beberapa kesan dari sahabat Netjoo</small>
                            </h2>
                        </div>
                        <!--/ Header -->
                        <!-- START row -->
                        <div class="row">
                            ...
                            <div class="col-sm-8 col-sm-offset-2 owl-carousel" id="customer-reviews">
                                ...
                                <div class="item text-center pt5">
                                    <blockquote class="nm">
                                        <p>“Sekarang jadi nggak takut lagi sama UN-BK. Bisa jauh-jauh hari latihan soal online di Netjoo. Ujiannya online, latihan juga online!” </p>
                                ...
                                <div class="item text-center pt5">
                                    <blockquote class="nm">
                                        <p>Sejak anak Saya pake Netjoo.com buat persiapan ujian, pengeluaran buat beli buku soal jadi jauh berkurang. Semuanya gratis tersedia di Netjoo.</p>
                                ...
                                <div class="item text-center pt5">
                                    <blockquote class="nm">
                                        <p>Saya bisa bikin latihan soal terpadu dan tryout langsung dari Netjoo.com. Selesai ujian, hasilnya dan analisi belajar siswa langsung ada. Memudahkan pekerjaan saya!</p>
