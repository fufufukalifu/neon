                            ...
                            <div class="panel-collapse">
                                <div class="panel-body">
                                    <div class="col-md-4">
                                        ...
                                        <img class="img-square img-bordered" src="<?=base_url('assets/image/avatar/cat1.jpg');?>" alt="" width="120px" height="120px">
                                    ...
                                    <div class="col-md-8">
                                        <table class="table">
                                            ...
                                            <tr>
                                                <td></td>
                                                <td><a href="halamantest.html"><button class="btn btn-primary">Kerjakan</button></a></td>
