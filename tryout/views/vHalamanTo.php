                                            ...
                                            <div class="panel panel-default" style="">
                                                <div class="panel-heading">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <!-- <input type="text" value="<?= $key['judul'] ?>" name="soal-[<?= $key['soalid']; ?>]"> -->
                                                        ...
                                                        <div class="col-md-10 col-md-offset-1">
                                                            ...
                                                            <div class="mb10">
                                                                ...
                                                                <label id="<?=$key['soalid'].$indexpil;?>" 
                                                                    onclick="changeColor('<?=$key['soalid'].$indexpil;?>',<?=$key['soalid']?>)" 
                                                                    alt="<?=$key['soalid'];?>" 
                    ...
                    <div class="panel-body">
                        <div class="row">
                            ...
                            <div class="col-md-12" style="">
                                ...
                                <a type="button" class="btn btn-info btn-block backup">Backup Jawaban</a>
...
$('.backup').click(function(){
    backup_jawaban = $('#hasil').serialize();
    $.ajax({
        url:base_url+"tryout/backup_jawaban",
        type:"POST",
        data:backup_jawaban,
        dataType:"TEXT",
